...
def overall(var, sign):
	'''The function, overall, takes in a string, the zodiac sign, and another string, var, that represents 
	the column in which the user wants to know about over a long term period.
	The return value is the most prominent mood over the 3 day period.'''
